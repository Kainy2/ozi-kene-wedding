          ...
          if (status === 'ATTENDING' && email) {
            try {
              await sendRsvpConfirmation({
                ...
                churchAddress: config.events.day1.church.address,
                churchTime: config.events.day1.church.time,
                churchMapLink: config.events.day1.church.mapLink,
                receptionName: config.events.day1.reception.name,
